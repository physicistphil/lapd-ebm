...
def plot_all_msi(data_samps, data_valid, data_valid_idx, mean, ptp):
...
def plot_diagnostics_histogram(data_samps, data, mean, ptp):
    n_bins = 200
    fig, axes = plt.subplots(4, 2, figsize=(8, 7), dpi=200)
...
if __name__ == '__main__':
    ...
    filepaths = ['2022-05-31_11h-15m-31s/checkpoints/model-0-3.pt',
                 '2022-05-31_11h-15m-31s/checkpoints/model-0-408.pt',
                 '2022-05-31_11h-15m-31s/checkpoints/model-0-813.pt',
                 '2022-05-31_11h-15m-31s/checkpoints/model-0-1218.pt',
                 '2022-05-31_01h-02m-30s/checkpoints/model-0-3.pt',
                 '2022-05-31_01h-02m-30s/checkpoints/model-0-407.pt',
                 '2022-05-31_01h-02m-30s/checkpoints/model-0-811.pt',
                 '2022-05-31_01h-02m-30s/checkpoints/model-0-1215.pt',
                 '2022-05-31_01h-02m-30s/checkpoints/model-0-1619.pt',
                 '2022-05-31_01h-02m-30s/checkpoints/model-0-2023.pt',
                 '2022-05-31_01h-02m-30s/checkpoints/model-0-2427.pt',
                 '2022-05-31_01h-02m-30s/checkpoints/model-0-2832.pt',
                 '2022-05-31_01h-02m-30s/checkpoints/model-0-3237.pt',
                 '2022-05-31_01h-02m-30s/checkpoints/model-0-3642.pt',
                 '2022-05-31_01h-02m-30s/checkpoints/model-0-4047.pt'
                 ]
    ...
    for f in filepaths:
        ...
        # ------------------------------------------ #
            ...
            plot_all_msi(data_samps, data_valid, data_valid_idx, mean, ptp)
            ...
            plot_diagnostics_histogram(data_samps, data, mean, ptp)
