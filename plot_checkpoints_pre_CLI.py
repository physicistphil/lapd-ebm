...
if __name__ == '__main__':
    ...
    filepaths = [
                 # '2022-09-29_00h-20m-24s/checkpoints/model-0-2673.pt',
                 # '2022-09-29_00h-20m-24s/checkpoints/model-0-2026.pt',
                 # '2022-09-29_00h-20m-24s/checkpoints/model-0-1372.pt',
                 # '2022-09-29_00h-20m-24s/checkpoints/model-0-718.pt',
                 # '2022-09-29_00h-20m-24s/checkpoints/model-0-3.pt',

                 # '2022-09-29_00h-21m-08s/checkpoints/model-0-4892.pt',
                 # '2022-09-29_00h-21m-08s/checkpoints/model-0-3688.pt',
                 # '2022-09-29_00h-21m-08s/checkpoints/model-0-2484.pt',
                 # '2022-09-29_00h-21m-08s/checkpoints/model-0-1280.pt',
                 # '2022-09-29_00h-21m-08s/checkpoints/model-0-3.pt',

                 # '2022-09-29_00h-21m-44s/checkpoints/model-0-4248.pt',
                 # '2022-09-29_00h-21m-44s/checkpoints/model-0-3194.pt',
                 # '2022-09-29_00h-21m-44s/checkpoints/model-0-2133.pt',
                 # '2022-09-29_00h-21m-44s/checkpoints/model-0-1072.pt',
                 # '2022-09-29_00h-21m-44s/checkpoints/model-0-3.pt',

                 # '2022-09-29_00h-21m-54s/checkpoints/model-0-2533.pt',
                 # '2022-09-29_00h-21m-54s/checkpoints/model-0-1901.pt',
                 # '2022-09-29_00h-21m-54s/checkpoints/model-0-1266.pt',
                 # '2022-09-29_00h-21m-54s/checkpoints/model-0-633.pt',
                 # '2022-09-29_00h-21m-54s/checkpoints/model-0-3.pt',

                 # ————— #

                 '2022-09-29_04h-20m-48s/checkpoints/model-0-2613.pt',
                 '2022-09-29_04h-20m-48s/checkpoints/model-0-1965.pt',
                 '2022-09-29_04h-20m-48s/checkpoints/model-0-1311.pt',
                 '2022-09-29_04h-20m-48s/checkpoints/model-0-657.pt',
                 '2022-09-29_04h-20m-48s/checkpoints/model-0-3.pt',

                 # '2022-09-29_04h-21m-27s/checkpoints/model-0-4824.pt',
                 # '2022-09-29_04h-21m-27s/checkpoints/model-0-3620.pt',
                 # '2022-09-29_04h-21m-27s/checkpoints/model-0-2415.pt',
                 # '2022-09-29_04h-21m-27s/checkpoints/model-0-1211.pt',
                 # '2022-09-29_04h-21m-27s/checkpoints/model-0-3.pt',

                 # '2022-09-29_04h-22m-02s/checkpoints/model-0-4246.pt',
                 # '2022-09-29_04h-22m-02s/checkpoints/model-0-3191.pt',
                 # '2022-09-29_04h-22m-02s/checkpoints/model-0-2128.pt',
                 # '2022-09-29_04h-22m-02s/checkpoints/model-0-1065.pt',
                 # '2022-09-29_04h-22m-02s/checkpoints/model-0-3.pt',

                 # '2022-09-29_04h-22m-18s/checkpoints/model-0-2552.pt',
                 # '2022-09-29_04h-22m-18s/checkpoints/model-0-1920.pt',
                 # '2022-09-29_04h-22m-18s/checkpoints/model-0-1281.pt',
                 # '2022-09-29_04h-22m-18s/checkpoints/model-0-640.pt',
                 # '2022-09-29_04h-22m-18s/checkpoints/model-0-3.pt',

                 # ————— #

                 '2022-09-29_08h-21m-17s/checkpoints/model-0-2604.pt',
                 '2022-09-29_08h-21m-17s/checkpoints/model-0-1970.pt',
                 '2022-09-29_08h-21m-17s/checkpoints/model-0-1315.pt',
                 '2022-09-29_08h-21m-17s/checkpoints/model-0-659.pt',
                 '2022-09-29_08h-21m-17s/checkpoints/model-0-3.pt',

                 # '2022-09-29_08h-21m-50s/checkpoints/model-0-4744.pt',
                 # '2022-09-29_08h-21m-50s/checkpoints/model-0-3622.pt',
                 # '2022-09-29_08h-21m-50s/checkpoints/model-0-2418.pt',
                 # '2022-09-29_08h-21m-50s/checkpoints/model-0-1212.pt',
                 # '2022-09-29_08h-21m-50s/checkpoints/model-0-3.pt',

                 # '2022-09-29_08h-22m-21s/checkpoints/model-0-4171.pt',
                 # '2022-09-29_08h-22m-21s/checkpoints/model-0-3193.pt',
                 # '2022-09-29_08h-22m-21s/checkpoints/model-0-2130.pt',
                 # '2022-09-29_08h-22m-21s/checkpoints/model-0-1067.pt',
                 # '2022-09-29_08h-22m-21s/checkpoints/model-0-3.pt',

                 # '2022-09-29_08h-22m-37s/checkpoints/model-0-2543.pt',
                 # '2022-09-29_08h-22m-37s/checkpoints/model-0-1928.pt',
                 # '2022-09-29_08h-22m-37s/checkpoints/model-0-1287.pt',
                 # '2022-09-29_08h-22m-37s/checkpoints/model-0-642.pt',
                 # '2022-09-29_08h-22m-37s/checkpoints/model-0-3.pt',

                 # ————— #

                 '2022-09-29_12h-21m-47s/checkpoints/model-0-2570.pt',
                 '2022-09-29_12h-21m-47s/checkpoints/model-0-1925.pt',
                 '2022-09-29_12h-21m-47s/checkpoints/model-0-1274.pt',
                 '2022-09-29_12h-21m-47s/checkpoints/model-0-638.pt',
                 '2022-09-29_12h-21m-47s/checkpoints/model-0-3.pt',

                 # '2022-09-29_12h-22m-16s/checkpoints/model-1-1511.pt',
                 # '2022-09-29_12h-22m-16s/checkpoints/model-1-316.pt',
                 # '2022-09-29_12h-22m-16s/checkpoints/model-0-2165.pt',
                 # '2022-09-29_12h-22m-16s/checkpoints/model-0-1071.pt',
                 # '2022-09-29_12h-22m-16s/checkpoints/model-0-3.pt',

                 # '2022-09-29_12h-22m-46s/checkpoints/model-1-975.pt',
                 # '2022-09-29_12h-22m-46s/checkpoints/model-0-2969.pt',
                 # '2022-09-29_12h-22m-46s/checkpoints/model-0-1910.pt',
                 # '2022-09-29_12h-22m-46s/checkpoints/model-0-950.pt',
                 # '2022-09-29_12h-22m-46s/checkpoints/model-0-3.pt',

                 # '2022-09-29_12h-22m-57s/checkpoints/model-0-2439.pt',
                 # '2022-09-29_12h-22m-57s/checkpoints/model-0-1835.pt',
                 # '2022-09-29_12h-22m-57s/checkpoints/model-0-1220.pt',
                 # '2022-09-29_12h-22m-57s/checkpoints/model-0-613.pt',
                 # '2022-09-29_12h-22m-57s/checkpoints/model-0-3.pt',
                 ]
    ...
    for f in filepaths:
        try:
            ...
            with open(rundir + "/" + "modular_ebm_copy.py", 'r') as infile:
                for line in infile:
                    ...
                    if "\'dataset\': " in line:  # edited for data mode size eval
                        data_filename = "data/" + (line[20:-2])
        ...
        # ------------------------------------------ #
            ...
            # if 'train' in data_filename:  # edited for data mode size eval
            ...
            data_path = data_filename  # edited for data mode size eval

            data = ebm.load_data(data_path)

            data_valid = data  # edited for data mode size eval
